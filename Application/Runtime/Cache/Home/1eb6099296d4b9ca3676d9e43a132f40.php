...
<link rel="stylesheet" href="/Test/ohana-php/Public/Home-css/style.css">
  <link rel="stylesheet" href="/Test/ohana-php/Public/Home-css/guestBook.css">
  <title>留言板</title>
</head>
<body>
  <div class="header">
  ...
  <div class="frame">
    ...
    <ul class="list list-s1" data-role="accordion">
        <?php if(is_array($navigation)): foreach($navigation as $k=>$nav): ?><li>
            ...
            <ul class="child-list">
              <?php $__FOR_START_5488__=0;$__FOR_END_5488__=count($nav['children:']);for($i=$__FOR_START_5488__;$i < $__FOR_END_5488__;$i+=1){ ?><li><a href="<?php echo U('articleList/articleList', array(), '');?>/id/<?php echo ($nav['children:'][$i]['id']); ?>"><?php echo ($nav['children:'][$i]['name']); ?>(<?php echo(count($nav['children:'][$i]['children:'])) ?>)</a> </li><?php } ?>
            </ul>
