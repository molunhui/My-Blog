  ...
  <div class="frame">
    ...
    <ul class="list list-s1" data-role="accordion">
        <?php if(is_array($navigation)): foreach($navigation as $k=>$nav): ?><li>
            ...
            <ul class="child-list">
              <?php $__FOR_START_5678__=0;$__FOR_END_5678__=count($nav['children:']);for($i=$__FOR_START_5678__;$i < $__FOR_END_5678__;$i+=1){ ?><!--<li><a href="/Test/ohana-php/article/<?php echo ($nav["title"]); ?>" ><?php echo ($nav['children:'][$i]['name']); ?></a></li>-->
