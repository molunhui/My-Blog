...
<div class="nav-swf">
  ...
  <div class="container">
    <div class="main" id="main">
      ...
      <!-- 多说评论框 start -->
      <div class="ds-thread" data-thread-key="<?php echo ($article["id"]); ?>" data-title="<?php echo ($article["title"]); ?>" data-url="/git/ohana-php/home/article/<?php echo ($article["id"]); ?>"></div>
      <!-- 多说评论框 end -->
  ...
  <div class="frame">
    ...
    <ul class="list list-s1" data-role="accordion">
        <?php if(is_array($navigation)): foreach($navigation as $k=>$nav): ?><li>
            ...
            <ul class="child-list">
              <?php $__FOR_START_14459__=0;$__FOR_END_14459__=count($nav['children:']);for($i=$__FOR_START_14459__;$i < $__FOR_END_14459__;$i+=1){ ?><li><a href="/git/ohana-php/home/article/list/<?php echo ($nav['children:'][$i]['id']); ?>"><?php echo ($nav['children:'][$i]['name']); ?>(<?php echo(count($nav['children:'][$i]['children:'])) ?>)</a> </li><?php } ?>
            </ul>
