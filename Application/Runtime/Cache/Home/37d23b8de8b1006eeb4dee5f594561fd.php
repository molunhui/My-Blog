...
<div class="nav-swf">
  ...
  <div class="container">
    <div class="main" id="main">
      ...
      <!-- 多说评论框 start -->
      <div class="ds-thread" data-thread-key="<?php echo ($article["id"]); ?>" data-title="<?php echo ($article["title"]); ?>" data-url="/Test/ohana-php/home/article/<?php echo ($article["id"]); ?>"></div>
      <!-- 多说评论框 end -->
  ...
  <div class="frame">
    ...
    <ul class="list list-s1" data-role="accordion">
        <?php if(is_array($navigation)): foreach($navigation as $k=>$nav): ?><li>
            <i class="arrow_carrot-2right" data-role="click-it"></i><a href="/Test/ohana-php/home/article/list/<?php echo ($nav["id"]); ?>"><?php echo ($nav["name"]); ?>(<?php echo(count($nav['children:'])) ?>)</a>
            <ul class="child-list">
              <?php $__FOR_START_25231__=0;$__FOR_END_25231__=count($nav['children:']);for($i=$__FOR_START_25231__;$i < $__FOR_END_25231__;$i+=1){ ?><li><a href="/Test/ohana-php/home/article/list/<?php echo ($nav['children:'][$i]['id']); ?>"><?php echo ($nav['children:'][$i]['name']); ?>(<?php echo(count($nav['children:'][$i]['children:'])) ?>)</a> </li><?php } ?>
            </ul>
