  ...
  <div class="frame">
    ...
    <ul class="list list-s1" data-role="accordion">
        <?php if(is_array($navigation)): foreach($navigation as $k=>$nav): ?><li>
            ...
            <ul class="child-list">
              <?php $__FOR_START_6706__=0;$__FOR_END_6706__=count($nav['children:']);for($i=$__FOR_START_6706__;$i < $__FOR_END_6706__;$i+=1){ ?><li><a href="<?php echo U('articleList/articleList', array(), '');?>/id/<?php echo ($nav['children:'][$i]['id']); ?>"><?php echo ($nav['children:'][$i]['name']); ?>(<?php echo(count($nav['children:'][$i]['children:'])) ?>)</a> </li><?php } ?>
            </ul>
