...
<div class="container">
  <div class="main" id="main">
    ...
    <div class="articleStyle">
      ...
      <p class="message"><span>2014-12-30</span><span>作者：Allen</span><span>分类：<a href="/"
                                                                                 target="_blank">心得笔记</a></span><span>阅读(229)</span><span>评论(124)</span>
      </p>
    </div>
    ...
    <div class="frame">
      ...
      <ul class="list list-s1" data-role="accordion">
        <?php if (is_array($navigation)): foreach ($navigation as $k => $nav): ?>
          ...
          <ul class="child-list">
            <?php $__FOR_START_6706__ = 0;
            $__FOR_END_6706__ = count($nav['children:']);
            for ($i = $__FOR_START_6706__; $i < $__FOR_END_6706__; $i += 1) { ?>
              <li><a
