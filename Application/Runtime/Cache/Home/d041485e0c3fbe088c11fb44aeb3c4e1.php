    ...
    <div class="main" id="main">
      ...
      <div class="text-center">
        <ul class="pagination">
          ...
          <?php $__FOR_START_27085__=1;$__FOR_END_27085__=$page['page_count'] + 1;for($i=$__FOR_START_27085__;$i < $__FOR_END_27085__;$i+=1){ ?><li>
  ...
  <div class="frame">
    ...
    <ul class="list list-s1" data-role="accordion">
        <?php if(is_array($navigation)): foreach($navigation as $k=>$nav): ?><li>
            ...
            <ul class="child-list">
              <?php $__FOR_START_4964__=0;$__FOR_END_4964__=count($nav['children:']);for($i=$__FOR_START_4964__;$i < $__FOR_END_4964__;$i+=1){ ?><li><a href="<?php echo U('articleList/articleList', array(), '');?>/id/<?php echo ($nav['children:'][$i]['id']); ?>"><?php echo ($nav['children:'][$i]['name']); ?>(<?php echo(count($nav['children:'][$i]['children:'])) ?>)</a> </li><?php } ?>
            </ul>
