  ...
  <div class="nav" id="nav">
    <ul>
      ...
      <?php if(is_array($navigation)): $i = 0; $__LIST__ = $navigation;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i; if($nav["pid"] == 0): ?><li>
            <a href="<?php echo U('article/_list', array(), '');?>/id/<?php echo ($nav["id"]); ?>"><?php echo ($nav["name"]); ?></a>
  ...
  <div class="main" id="main">
    ...
    <div class="text-center">
      <ul class="pagination">
        ...
        <?php $__FOR_START_10985__=1;$__FOR_END_10985__=$page['page_count'] + 1;for($i=$__FOR_START_10985__;$i < $__FOR_END_10985__;$i+=1){ ?><li>
  ...
  <div class="frame">
    ...
    <ul class="list list-s1" data-role="accordion">
        <?php if(is_array($navigation)): foreach($navigation as $k=>$nav): ?><li>
            ...
            <ul class="child-list">
              <?php $__FOR_START_30576__=0;$__FOR_END_30576__=count($nav['children:']);for($i=$__FOR_START_30576__;$i < $__FOR_END_30576__;$i+=1){ ?><li><a href="<?php echo U('articleList/articleList', array(), '');?>/id/<?php echo ($nav['children:'][$i]['id']); ?>"><?php echo ($nav['children:'][$i]['name']); ?>(<?php echo(count($nav['children:'][$i]['children:'])) ?>)</a> </li><?php } ?>
            </ul>
