...
<div class="container">
  <div class="main" id="main">
    <?php if(is_array($articleList)): $i = 0; $__LIST__ = $articleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><div class="articleStyle">
        ...
        <h2><a href="/git/ohana-php/home/article/<?php echo ($article["id"]); ?>" title="点击阅读全文"><?php echo ($article["title"]); ?></a></h2>
        ...
        <p class="article-more-link">
          <a href="/git/ohana-php/home/article/<?php echo ($article["id"]); ?>">阅读全文</a>
        </p>
      ...
      <ul class="pagination">
        ...
        <?php $__FOR_START_23040__=1;$__FOR_END_23040__=$page['page_count'] + 1;for($i=$__FOR_START_23040__;$i < $__FOR_END_23040__;$i+=1){ ?><li>
            <?php if($i == $page['page']): ?><span><?php echo ($page["page"]); ?></span>
              ...
              <a href="/git/ohana-php/home/article/list/<?php echo ($article["cid"]); ?>/<?php echo ($i); ?>"><?php echo ($i); ?></a><?php endif; ?>
          </li><?php } ?>
        <li>
          <?php if($page['page'] >= $page['page_count']): ?><span>下一页</span>
            <?php else: ?>
            <a href="/git/ohana-php/home/article/list/<?php echo ($article["cid"]); ?>/<?php echo ($page['page'] + 1); ?>">下一页</a><?php endif; ?>
        </li>
      </ul>
    </div>
