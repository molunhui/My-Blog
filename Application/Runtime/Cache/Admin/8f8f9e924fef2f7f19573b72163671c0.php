      ...
      <div class="text-center">
        <ul class="pagination">
          <li>
            ...
            <?php else: ?>
            <a href="<?php echo U('articleList', '', ''); ?>/page/<?php echo($page['page'] - 1); ?>">
                上一页</a><?php endif; ?>
          </li>
          <?php $__FOR_START_15104__ = 1;
          $__FOR_END_15104__ = $page['page_count'] + 1;
          for ($i = $__FOR_START_15104__; $i < $__FOR_END_15104__; $i += 1) { ?>
            <li>
            <?php if ($i == $page['page']): ?><span><?php echo($page["page"]); ?></span>
            <?php else: ?>
              <a
              href="<?php echo U('articleList', '', ''); ?>/page/<?php echo($i); ?>"><?php echo($i); ?></a><?php endif; ?>
            </li><?php } ?>
          <li>
