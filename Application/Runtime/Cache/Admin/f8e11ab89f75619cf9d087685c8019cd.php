    ...
    <div class="content">
      <form class="form-horizontal" role="form" style="width: 365px;" action="<?php echo U(runEdit); ?>" method="post">
        <div class="form-group">
          ...
          <div class="col-md-8">
            <input value="<?php echo($site["name"]); ?>" class="form-control required"
                   title="Please type a website name" type="text" name="name"/>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-8">
            <?php if (!empty($site['logo'])): ?><img id="logo_img"
                                                     src="/Test/ohana-php/Public/upload/img/<?php echo($site["logo"]); ?>"
                                                     alt="LOGO" /><?php endif; ?>
          </div>
        </div>
        <div class="form-group">
