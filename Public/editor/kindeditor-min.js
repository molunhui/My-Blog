...
(function (w, i) {
  ...
  if (!w.KindEditor) {
    ...
    E(ta, S, {init: function (a) {
      ...
      this.mask = null;
      if (k)d = G(this.doc), this.mask = Ya({x: 0, y: 0, z: this.z - 1, cls: "ke-dialog-mask", width: Math.max(d.scrollWidth, d.clientWidth), height: Math.max(d.scrollHeight, d.clientHeight)});
    ...
    ua.prototype = {lang: function (a) {
      ...
      } else b._fullscreenExecuted && (f(document.body).css({height: "", overflow: ""}), f(document.body.parentNode).css("overflow", "")), b._scrollPos && w.scrollTo(b._scrollPos.x, b._scrollPos.y);
      var i = [];
      ...
      var h = b.toolbar = Cb({src: h, html: i.join(""), noDisableItems: b.noDisableItems, click: function (a, c) {
        a.stop();
        if (b.menu) {
          var d = b.menu.name;
          b.hideMenu();
        ...
        b.clickToolbar(c)
      }}), l = t(e) - h.div.height(), m = b.edit = Ab({height: l > 0 && t(e) > b.minHeight ? l : b.minHeight,
        src: j, srcElement: b.srcElement, designMode: b.designMode, themesPath: b.themesPath, bodyClass: b.bodyClass, cssPath: b.cssPath, cssData: b.cssData, beforeGetHtml: function (a) {
          a = b.beforeGetHtml(a);
          a = T(Fa(a));
      ...
      c ? (b._fullscreenResizeHandler = function () {
        ...
        b._scrollPos = ca()
      }), b.resizeType > 0 ? Wa({moveEl: g, clickEl: k, moveFn: function (a, c, d, e, g, f) {
        e += f;
        b.resize(null, e)
      }}) : k.first().css("visibility", "hidden"), b.resizeType === 2 ? Wa({moveEl: g, clickEl: k.last(), moveFn: function (a, c, d, e, g, f) {
        d += g;
        e += f;
        b.resize(d, e)
    ...
    Gb("core", function (a) {
      ...
      b.clickToolbar("formatblock", function () {
        var a = b.lang("formatblock.formatBlock"), c = {h1: 28, h2: 24, h3: 18, H4: 14, p: 12}, d = b.cmd.val("formatblock"), f = b.createMenu({name: "formatblock", width: b.langType == "en" ? 200 : 150});
        m(a, function (a, e) {
          var i = "font-size:" + c[a] + "px;";
          a.charAt(0) === "h" && (i += "font-weight:bold;");
          f.addItem({title: '<span style="' +
      ...
      b.clickToolbar("fontname", function () {
        ...
        m(b.lang("fontname.fontName"), function (d, f) {
          c.addItem({title: '<span style="font-family: ' + d + ';" unselectable="on">' + f + "</span>", checked: a === d.toLowerCase() || a === f.toLowerCase(), click: function () {
      ...
      b.clickToolbar("fontsize",
          function () {
            ...
            m(b.fontSizeTable, function (d, f) {
              c.addItem({title: '<span style="font-size:' + f + ';" unselectable="on">' + f + "</span>", height: t(f) + 12, checked: a === f, click: function () {
      ...
      b.afterCreate(function () {
        ...
        a(d.body).bind("paste", function (p) {
          if (b.pasteType === 0)p.stop(); else if (!m) {
            ...
            i = a('<div class="' + l + '"></div>', d).css({position: "absolute", width: "1px", height: "1px", overflow: "hidden", left: "-1981px", top: a(j.start).pos().y +
